...
<head>
    ...
    <link rel="stylesheet" href="ce_styles.css">
</head>
...
<body>
    ...
    <div class="main">
        <div class="card">
            <div class="up">Number of Entries in CE</div>
            <div class="down">
                <h4>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\CE\tot_ent.php'; ?>
                </h4>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h4>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\CE\ovr_ind.php'; ?>
                </h4>
            </div>
        </div>
        <div class="card"></div>
        <div class="card">
            ...
            <div class="down4">
                <?php include 'C:\xampp\htdocs\Prog\Charts\CE_chart.php'; ?>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h6>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\CE\tot_mf.php';
                    echo $mno; ?>
                </h6>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h6>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\CE\ind_mf.php';
                    echo $m_value; ?>
                </h6>
            </div>
        </div>
