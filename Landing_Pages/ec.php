...
<head>
    ...
    <link rel="stylesheet" href="ec_styles.css">
</head>
<body>
    ...
    <div class="main">
        <div class="card">
            <div class="up">Number of Entries in EC</div>
            <div class="down">
                <h4>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\EC\tot_ent.php'; ?>
                </h4>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h4>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\EC\ovr_ind.php'; ?>
                </h4>
            </div>
        </div>
        <div class="card"></div>
        <div class="card">
            ...
            <div class="down4">
                <?php include 'C:\xampp\htdocs\Prog\Charts\EC_chart.php'; ?>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h6>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\EC\tot_mf.php';
                    echo $mno; ?>
                </h6>
            </div>
        </div>
        <div class="card">
            ...
            <div class="down">
                <h6>
                    <?php include 'C:\xampp\htdocs\Prog\Card_Values\EC\ind_mf.php';
                    echo $m_value; ?>
                </h6>
            </div>
        </div>
